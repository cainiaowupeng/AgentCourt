...
parser.add_argument('--prompt_template_path', default='D:\AgentCourt-main\AgentCourt_辩论自动停止机制\prompts\AgentTemplate.txt', type=str, help='Base Prompt Template')
parser.add_argument('--prompt_judge_settings_path', default='D:\AgentCourt-main\AgentCourt_辩论自动停止机制\prompts\JudgeSettings.txt', type=str, help='Judge Settings Prompt Template')
parser.add_argument('--prompt_lawyer_settings_path', default='D:\AgentCourt-main\AgentCourt_辩论自动停止机制\prompts\LawyerSettings.txt', type=str, help='Lawyer Settings Prompt Template')
parser.add_argument('--prompt_judge_case_info_path', default='D:\AgentCourt-main\AgentCourt_辩论自动停止机制\prompts\JudgeCaseInfoTemplate.txt', type=str, help='Prompt of Judge Cases Info')
parser.add_argument('--prompt_left_case_info_path', default='D:\AgentCourt-main\AgentCourt_辩论自动停止机制\prompts\LeftCaseInfoTemplate.txt', type=str, help='Prompt of Left Case Info')
parser.add_argument('--prompt_right_case_info_path', default='D:\AgentCourt-main\AgentCourt_辩论自动停止机制\prompts\RightCaseInfoTemplate.txt', type=str, help='Prompt of Right Case Info')
parser.add_argument('--prompt_judgement_path', default='D:\AgentCourt-main\AgentCourt_辩论自动停止机制\prompts\JudgementTemplate.txt', type=str, help='Prompt of Judgement')
parser.add_argument('--prompt_check_path', default='D:\AgentCourt-main\AgentCourt_辩论自动停止机制\prompts\CheckTemplate.txt', type=str, help='Prompt of Check')
parser.add_argument('--prompt_check_intention_path', default='D:\AgentCourt-main\AgentCourt_辩论自动停止机制\prompts\IntentionCheckTemplate.txt', type=str, help='Prompt of Intention Check')
parser.add_argument('--role_setting_path', default=r'D:\AgentCourt-main\AgentCourt_辩论自动停止机制\role_setting.json', type=str, help='Role Settings')
parser.add_argument('--sample_path', default='D:\AgentCourt-main\AgentCourt_辩论自动停止机制\sample.json', type=str, help='Sample Data for test')
...
parser.add_argument('--embeddingmodel', type=str, default='D:\A.模拟法庭论文\模拟法庭框架_最高院服务器\BGE', help='Embedding Model') ##zzj新增
